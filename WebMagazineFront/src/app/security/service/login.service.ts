...
export class LoginService {
  ...
  getTokenFromClaveRecuperacion(claveRecuperacion: string | null, email: string | null ): Observable<string>{
    return this.http.get<any>(this.endpoint + "/usuarios/search/getTokenFromClaveRecuperacion/" + claveRecuperacion + "/" + email);
  }
