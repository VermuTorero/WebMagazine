		...
		try {
			...
			getEmailSender().sendEmail(usuario.getEmail(), "confirma la suscripcion",
					"Haz click en el siguiente enlace para verificar tu email: http://vermutorero-c484281d5ea5.herokuapp.com/usuarios/search/confirmarEmail/" + String.valueOf(codigoActivacion) 
							+ "\r\n"
							+ "\r\n"
							+ "\"Al registrarte en nuestra aplicaci�n, debes aceptar los siguientes t�rminos y condiciones:\r\n"
							+ "\r\n"
							+ "T�rminos y condiciones de uso: Aceptas cumplir con los t�rminos y condiciones establecidos para el uso de nuestra aplicaci�n. Esto incluye el compromiso de utilizar la aplicaci�n de manera �tica y respetar los derechos de propiedad intelectual.\r\n"
							+ "\r\n"
							+ "Pol�tica de privacidad: Reconoces y aceptas nuestra pol�tica de privacidad, que describe c�mo recopilamos, utilizamos, almacenamos y protegemos tu informaci�n personal. Esta informaci�n incluye tu nombre y correo electr�nico, que utilizamos para proporcionarte acceso a la aplicaci�n y comunicarnos contigo de manera efectiva.\r\n"
							+ "\r\n"
							+ "Consentimiento para el procesamiento de datos: Al registrarte, otorgas tu consentimiento para que procesemos tus datos personales de acuerdo con nuestra pol�tica de privacidad. Esto implica que almacenaremos y utilizaremos tu informaci�n personal para los fines establecidos en nuestra pol�tica de privacidad.\r\n"
							+ "\r\n"
							+ "Comunicaciones adicionales: Si optas por recibir comunicaciones adicionales, como boletines informativos o promociones, nos das permiso para envi�rtelas a la direcci�n de correo electr�nico proporcionada. Si en alg�n momento deseas dejar de recibir estas comunicaciones, podr�s darte de baja siguiendo las instrucciones proporcionadas en cada mensaje.\r\n"
							+ "\r\n"
							+ "Al hacer clic en el bot�n de registro, confirmas que has le�do y aceptado los t�rminos y condiciones, as� como nuestra pol�tica de privacidad. Asimismo, garantizas que proporcionas informaci�n veraz y te comprometes a utilizar la aplicaci�n de manera responsable.\r\n"
							+ "\r\n"
							+ "Si tienes alguna pregunta o inquietud sobre nuestros t�rminos y condiciones o nuestra pol�tica de privacidad, no dudes en contactarnos.\"\r\n"
							+ "\r\n"
							+ "Esta aplicaci�n utiliza una pasarela de pago de Paypal, no obtiene ni almacena ning�n dato bancario ni de tu usuario o contrase�a de Paypal");
